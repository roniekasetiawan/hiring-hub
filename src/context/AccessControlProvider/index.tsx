...
const AccessControlProviderConfigContext =
  createContext<AccessControlProviderHookHasChecked>({
    hasChecked: false,
  });

export const useAccessControlConfig = () =>
  useContext(AccessControlProviderConfigContext);
