...
export function AuthenticationProvider({ children }: { children: ReactNode }) {
    ...
    const menus = useMemo(() => defaultMenusFor(user?.role ?? 'applicant'), [user?.role]);
...
export function useAuthenticationProvider() {
    ...
    if (!v) throw new Error('useAuthenticationProvider must be used within AuthenticationProvider');
    return v;
}
